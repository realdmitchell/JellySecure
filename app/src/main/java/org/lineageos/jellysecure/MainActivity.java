 ...
 */
package org.lineageos.jellysecure;
...
import org.lineageos.jellysecure.favorite.Favorite;
import org.lineageos.jellysecure.favorite.FavoriteActivity;
import org.lineageos.jellysecure.favorite.FavoriteDatabaseHandler;
import org.lineageos.jellysecure.history.HistoryActivity;
import org.lineageos.jellysecure.ui.EditTextExt;
import org.lineageos.jellysecure.utils.PrefsUtils;
import org.lineageos.jellysecure.utils.UiUtils;
import org.lineageos.jellysecure.webview.WebViewCompat;
import org.lineageos.jellysecure.webview.WebViewExt;
import org.lineageos.jellysecure.webview.WebViewExtActivity;
...
public class MainActivity extends WebViewExtActivity implements View.OnTouchListener,
    ...
    private static final String PROVIDER = "org.lineageos.jellysecure.fileprovider";
...
//                        mWebView.setDesktopMode(!isDesktop);
                        ...
                        // clearing app data
                            ...
                            runtime.exec("pm clear org.lineageos.jellysecure");
                                } catch (Exception e) {
                            e.printStackTrace();
                          }
//                        desktopMode.setTitle(getString(isDesktop ?
